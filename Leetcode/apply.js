...
function validate() {
  ...
  if (other && text === '') {
    document.getElementById('error-text').innerHTML = 'Please enter skills in the text area\n';
    result = false;
  }
  ...
  if (isNaN(age)) {
    document.getElementById('error-dob').innerHTML = 'Your age must be a number\n';
    result = false;
  } else if (age < 15) {
    document.getElementById('error-dob').innerHTML = 'Your age must be 15 or older\n';
    result = false;
  } else if (age >= 80) {
    document.getElementById('error-dob').innerHTML = 'Your age must be less than 80\n';
    result = false;
  }
...
function prefillForm() {
  ...
  if (sessionStorage.firstname !== undefined) {
    ...
    if (sessionStorage.html === 'html') document.getElementById('html').checked = true;
    if (sessionStorage.css === 'css') document.getElementById('css').checked = true;
    if (sessionStorage.javascript === 'javascript') document.getElementById('javascript').checked = true;
    if (sessionStorage.php === 'php') document.getElementById('php').checked = true;
    if (sessionStorage.mysql === 'mysql') document.getElementById('mysql').checked = true;
    if (sessionStorage.other === 'other') document.getElementById('other').checked = true;
